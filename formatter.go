...
var (
	...
	defaultCompiledColorScheme = setCompiledColor(defaultColorScheme)
)
...
func setCompiledColor(s *ColorScheme) *compiledColorScheme {
...
func (f *TextFormatter) SetColorScheme(colorScheme *ColorScheme) {
	f.colorScheme = setCompiledColor(colorScheme)
}
